    ...
    <div class="modal-content">
      ...
      <div class="modal-body" >
            ...
            <div class="form-floating ">
                <input type="text" placeholder="" name="uname" value="${deliveryobj.getDelId()}" class="form-control" required>
                <label for="" class="form-label"><i class="fa-solid fa-user"></i>&nbsp;User_Id</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelfullname() }" class="form-control" required>
            <label for="">&nbsp;Full Name</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelnickname() }" class="form-control" required>
            <label for="">&nbsp;Nick Name</label>
        </div>
        <div class="form-floating">
            <input type="email" placeholder="" name="pwd" value="${deliveryobj.getDelemail() }" class="form-control" required>
            <label for=""><i class="fa-solid fa-envelopes-bulk"></i>&nbsp;Email</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDellanguage()}" class="form-control" required>
            <label for=""><i class="fa-solid fa-language"></i>&nbsp;Language</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelCountry()}" class="form-control" required>
            <label for=""><i class="fa-solid fa-flag"></i>&nbsp;Country</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelstreet()}" class="form-control" required>
            <label for=""><i class="fa-solid fa-thermometer"></i>&nbsp;Street</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelCity()}" class="form-control" required>
            <label for=""><i class="fa-solid fa-city"></i>&nbsp;City</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelAddress()}" class="form-control" required>
            <label for=""><i class="fa-regular fa-address-card"></i>&nbsp;Address</label>
        </div>
        <div class="form-floating">
            <input type="text" placeholder="" name="pwd" value="${deliveryobj.getDelphone()}" class="form-control" required>
            <label for=""><i class="fa-regular fa-address-card"></i>&nbsp;Phone Number</label>
        </div>
       <a href="/home" <button class="btn glow-on-hover mt-4">Update</button>></a>
    </form>
      </div>
    </div>
  </div>
